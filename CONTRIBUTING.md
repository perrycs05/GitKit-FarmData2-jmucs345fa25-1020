...
Having a running version of FarmData2 is a prerequisite for many of the forms of participation.  The [Install Directions](INSTALL.md) give step by step instructions for getting FarmData2 up and running.
...
* Search the [Issue Tracker](https://github.com/DickinsonCollege/FarmData2/issues) to see if the bug has been reported already.
...
To participate by Gardening visit the [Issue Tracker](https://github.com/DickinsonCollege/FarmData2/issues) and find something of interest to verify, enhance or clarify.  Try it out in your running version of FarmData2 and add a comment to the ticket with what you find.
...
* Go to the [FarmData2 Repository](https://github.com/DickinsonCollege/FarmData2) (the *upstream*)
* Fork the *upstream* repository to your GitHub (the *origin*).
* [Clone](https://docs.github.com/en/free-pro-team@latest/github/creating-cloning-and-archiving-repositories/cloning-a-repository) the *origin* repository to your local machine.
...
* Commit your edits.
  ...
  * If the contribution reflects the work of multiple people, ensure that everyone receives attribution by [Creating a commit with multiple authors](https://docs.github.com/en/free-pro-team@latest/github/committing-changes-to-your-project/creating-a-commit-with-multiple-authors).
